<template>
    <nav class="nav nav-borders mx-auto py-2" style="background-color: white; max-width: 1250px; border-radius: 0.5rem">
        <router-link class="nav-link" :to="{name:'profile.details'}">{{ $t('component.accountNavigation.profile') }}</router-link>

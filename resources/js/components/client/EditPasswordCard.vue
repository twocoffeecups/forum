            ...
            <form>
                ...
                <div class="mb-3">
                    ...
                    <div :class="{ error: v$.user.oldPassword.$errors.length }">
                        <input @blur="v$.user.oldPassword.$touch" v-model.trim="user.oldPassword" type="password"
                               class="form-control form-control-lg" id="oldPassword">
                        <div class="input-errors my-2 text-danger small text-start"
                             v-for="error of v$.user.oldPassword.$errors" :key="error.$uid">
                ...
                <div class="mb-3">
                    ...
                    <div :class="{ error: v$.user.password.$errors.length }">
                        <input @blur="v$.user.password.$touch" v-model.trim="user.password" type="password"
                ...
                <div class="mb-3">
                    ...
                    <div :class="{ error: v$.user.passwordConfirmation.$errors.length }">
                        <input @blur="v$.user.passwordConfirmation.$touch" v-model.trim="user.passwordConfirmation"
                               type="password" :placeholder="$t('component.signUp.confirmPass')"
                               class="form-control form-control-lg" id="confirmPassword">
                        <div class="input-errors my-2 text-danger small text-start"
                             v-for="error of v$.user.passwordConfirmation.$errors" :key="error.$uid">
                            <div class="error-msg">{{ error.$message }}</div>
                        </div>
                    </div>
                </div>
                <button @click.prevent="updatePassword" class="btn btn-primary" type="button">

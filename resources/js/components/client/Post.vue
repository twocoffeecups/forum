                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-2 d-block d-md-flex d-lg-flex d-xl-flex justify-content-between">
                            <div class="flex-sm-row d-md-flex d-lg-flex d-xl-flex text-center">
                                <button @click.prevent="likePost" class="btn btn-xs text-muted has-icon"><i class="far fa-heart"></i> 1</button>
                        ...
                        <i class="fa fa-eye text-muted fsize-3"></i>&nbsp; <span class="align-middle"> 112</span>
                            ...
                            <div class="flex-sm-row d-md-flex d-lg-flex d-xl-flex text-center">
                                ...
                                <span @click.prevent="addPostToBookmarks" class="mx-1 p-2"> <i class="far fa-bookmark" style="cursor: pointer"></i></span>
                            </div>
...
export default {
    ...
    methods: {
        ...
        addPostToBookmarks() {
            this.$store.dispatch('addPostToBookmarks', this.postId);
        }

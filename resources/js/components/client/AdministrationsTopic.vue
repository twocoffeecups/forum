...
<!--                        <span class="op-6"> by</span> <router-link v-if="topic.author" class="badge bg-danger" :to="{name:'user.profile', params:{id:topic.author.id}}">{{ topic.author.name }}</router-link>-->
<!--                    </p>-->
                </div>
            ...
            <div class="d-flex">
                <p class="text-sm mx-3"><span class="op-6">{{ $t('component.topic.created') }} </span>
                    <a class="text-black" href="#"> {{ topic.created_at }}</a>
                    <span class="op-6"> by</span> <router-link v-if="topic.author" class="badge bg-danger" :to="{name:'user.profile', params:{id:topic.author.id}}">{{ topic.author.name }}</router-link>
                </p>
            </div>

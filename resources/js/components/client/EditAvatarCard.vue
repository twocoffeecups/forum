<template>
  <div class="card mb-4 mb-xl-0">
    ...
    <div class="card-body text-center position-relative">
      <!-- Avatar -->
      <img class="img-account-profile rounded-circle mb-2" :src="defaultAvatar" alt="">

      <div class="overlay">
        <div v-if="isFileUpload">
          <span class="mx-2 text-success" title="Upload"><i class="fas fa-check" @click="updateAvatar"></i></span>
          <span class="mx-2 text-danger" title="Remove"><i class="fas fa-times" @click="removeAvatar"></i></span>
        </div>
      </div>
...
export default {
  ...
  methods:{
    ...
    updateAvatar(){
      this.$store.dispatch('updateAvatar', this.newAvatar);

<template>
    <span role="button" class="text-primary" data-bs-toggle="modal" :data-bs-target="`#edit-forum-${id}-modal`" title="Edit">
        <i class="fas fa-edit"></i>
    </span>

  <div class="modal fade" :id="`edit-forum-${id}-modal`" tabindex="-1" :aria-labelledby="`edit-forum-${id}-modal`" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button @click="updateForum" data-bs-dismiss="modal" type="button" class="btn btn-primary">Update</button>
        </div>
      </div>
    </div>
  </div>

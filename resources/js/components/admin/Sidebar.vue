<template>
  ...
  <aside class="sidebar offcanvas offcanvas-start bg-dark bg-gradient" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="sidebar" aria-labelledby="sidebar" style="width: 270px">
    <div class="offcanvas-header">
      <h5 class="offcanvas-title fw-bold" style="color: white; font-size: 1.8em;">Dashboard</h5>
    </div>
    ...
    <div class="offcanvas-body">
      <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
        ...
        <!-- Forum -->
        <li class="nav-item w-100">
          <a class="nav-link sidebar_nav_link align-middle px-0" data-bs-toggle="collapse" href="#sub_menu1" role="button" aria-expanded="false" aria-controls="sub_menu1">
          ...
          <div class="collapse" id="sub_menu1">
            <ul class="collapse ps-3 show nav flex-column ms-1">
              <li class="w-100">
                <router-link :to="{name:'admin.forum'}" class="nav-link sidebar_nav_link px-0"> <i class="fas fa-hashtag"></i> Forums </router-link>
              </li>
              <li class="w-100">
                <router-link :to="{name:'admin.forumsTree'}" class="nav-link sidebar_nav_link px-0"> <i class="fas fa-hashtag"></i> Forums tree </router-link>
              </li>
              <li>
                <router-link :to="{name:'admin.tag'}" class="nav-link sidebar_nav_link px-0"> <i class="fas fa-hashtag"></i> Tags </router-link>
              </li>
              <li>
                <router-link :to="{name:'admin.topic'}" class="nav-link sidebar_nav_link px-0"> <i class="fas fa-hashtag"></i> Topics </router-link>
              </li>
            </ul>
          </div>
        </li>
        ...
        <!-- Role and Permission -->
        <li class="nav-item w-100">
          <a class="nav-link sidebar_nav_link  align-middle px-0" data-bs-toggle="collapse" href="#sub_menu2" role="button" aria-expanded="false" aria-controls="sub_menu2">
        ...
        <!-- Users -->
        <li class="nav-item w-100">
          <router-link :to="{ name:'admin.users' }" class="nav-link sidebar_nav_link align-middle px-0">

<template>
    <div class="d-flex justify-content-start mb-3">
        <button class="btn btn-primary bg-gradient mx-1" data-bs-toggle="modal" data-bs-target="#create-report-reason-modal">
            <i class="fas fa-plus mx-1"></i>Create reason type
        </button>
    </div>

    <div class="modal fade" id="create-report-reason-modal" tabindex="-1" aria-labelledby="create-tag-modal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Create report reason</h1>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button @click="createReportReason" data-bs-dismiss="modal" type="button"
...
export default {
    name: "CreateReportReasonTypeModal",

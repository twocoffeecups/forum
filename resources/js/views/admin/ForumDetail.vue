      ...
      <div class="card my-3">
        ...
        <div class="card-body">
          <dl class="row">
            ...
            <dd contenteditable class="col-sm-8" @input="updateContent($event, 'name')">{{ forum.name }}</dd>
            <dt class="col-sm-4">Type</dt>
            <dd class="col-sm-8">{{ forum.type }}</dd>
            <dt class="col-sm-4">Category</dt>
            <dd class="col-sm-8">
              {{ forum.parent }}
              <span role="button" class="fa-pull-right text-primary mx-2" @click="this.showSelect = !this.showSelect">
          ...
          <table class="table table-striped table-hover table-bordered">
            ...
            <tr v-for="forum in childrenForums">
              ...
              <td>
                ...
                <EditForumModal :id="forum.id" :forum-name="forum.name" :forum-description="forum.description" />
...
export default {
  ...
  methods:{
    ...
    updateContent(e, key){
      //console.log(key, e.target.innerText)

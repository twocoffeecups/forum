            ...
            <div class="card-body p-5 text-center">
              ...
              <div class="form-outline mb-4">
                <div :class="{ error: v$.user.email.$errors.length }">
                  <input @blur="v$.user.email.$touch" v-model.trim="user.email" type="email" :placeholder="$t('component.signIn.email')" class="form-control form-control-lg" id="email">
              ...
              <div class="form-outline mb-4">
                <div :class="{ error: v$.user.password.$errors.length }">
                  <input @blur="v$.user.password.$touch" type="password" v-model.trim="user.password" :placeholder="$t('component.signIn.password')" class="form-control form-control-lg" id="password">
              ...
              <div class="d-grid gap-2">
                <button class="btn btn-primary btn-lg bg-gradient" @click.prevent="signIn" type="submit">{{ $t('component.signIn.signIn') }}</button>
              </div>

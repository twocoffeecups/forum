...
$(document).ready(function () {
    !function (t, e) {
            ...
            A = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, k = {
                ...
                return e.next = function () {
                    ...
                    var n, o, r, a = this, s = this._element.querySelector(D), l = this._getItemIndex(s),
                        f = e || s && this._getItemByDirection(t, s), d = this._getItemIndex(f),
        ...
        i.default(document).on("click.bs.collapse.data-api", q, (function (t) {
            ...
            var e = i.default(this), n = u.getSelectorFromElement(this),
        ...
        function mt(t, e) {
            var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = tt(10),
                o = "HTML" === e.nodeName,
        ...
        var Yt = Vt, zt = "dropdown", Kt = "bs.dropdown", Xt = i.default.fn[zt], Gt = new RegExp("38|40|27"),
            $t = "disabled", Jt = "show", Zt = "dropdown-menu-right", te = "hide.bs.dropdown",
        ...
        var Ie = "tooltip", Oe = "bs.tooltip", xe = i.default.fn.tooltip, je = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
            Le = ["sanitize", "whiteList", "sanitizeFn"], Pe = "fade", Fe = "show", Re = "show", He = "out",
            Me = "hover",
            qe = "focus", Be = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, Qe = {
                ...
                return e.enable = function () {
                    ...
                    var e = this, n = this.getTipElement(), o = i.default.Event(this.constructor.Event.HIDE),
                        r = function () {
